                ...
                <div className="animated__wrapper" >
                    ...
                    <div className="hero--block">
                        <div className="hero__image">
                            <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/hero-angled.png"/>
                        </div>
                    </div>
                    ...
                    <div className="copy--content">
                        ...
                        <div className="copy--block">
                            <span className="copy__header">Mosey Case Study</span>
                            <hr/>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-old-app.jpg"/>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-lang.jpg"/>
                                <span className="image__label">UI language selection wireframe</span>
                            </div>
                            <div className="video--block--contain">
                                <Video autoPlay loop muted
                                     height="500px">
                                    <source src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/videos/vid-proto-lang.mov" type="video/mp4" />
                                </Video>
                            </div>
                        </div>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/sketch-random.jpg"/>
                                <span className="image__label">Refining Content Structure</span>
                            </div>
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-all.jpg"/>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-tabs.jpg"/>
                                <span className="image__label">Exploring Different Tab Solutions</span>
                            </div>
                            <div className="video--block--contain">
                                <Video autoPlay loop muted
                                    poster="http://sourceposter.jpg" height="500px">
                                    <source src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/videos/vid-proto-tabs.mov" type="video/mp4" />
                                </Video>
                            </div>
                        </div>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/sketch-filtering.jpg"/>
                                <span className="image__label">Early filtering functionality</span>
                            </div>
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-guide-lang.jpg"/>
                                <span className="image__label">Lo-fi filtering prototype</span>
                            </div>
                            <div className="video--block--contain">
                                <Video autoPlay loop muted
                                    height="500px">
                                    <source src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/videos/vid-proto-guide.mov" type="video/mp4" />
                                </Video>
                            </div>
                        </div>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/sketch-one.jpg"/>
                            </div>
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/wires-tools.jpg"/>
                        ...
                        <div className="copy--block">
                            ...
                            <div className="image--block--contain">
                                <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/design-filtering.png"/>
                            </div>
                        </div>

                        <div className="image--block--full">
                            <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/design-products-trio.jpg"/>
                            <img src="https://jmanhart.github.io/snips/src/public/images/cobb-case-study/design-products-trio.jpg"/>
                        </div>
